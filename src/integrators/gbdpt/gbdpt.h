...
struct GBDPTConfiguration {
	int maxDepth, blockSize, minDepth;
	int minCameraDepth;
	bool lightImage;
	bool sampleDirect;
	size_t sampleCount;
    ...
    bool nanCheck;
  	...
  	ELightingEffects lightingInteractionMode;
	...
	inline GBDPTConfiguration(Stream *stream) {
        ...
        lightingInteractionMode = (ELightingEffects)stream->readInt();
	}
	...
	inline void serialize(Stream *stream) const {
        ...
        stream->writeInt(lightingInteractionMode);
