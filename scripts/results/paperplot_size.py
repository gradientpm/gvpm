...
if __name__=="__main__":
    ...
    algorithms = []
    algorithms += [ AlgorithmPlot("BRE (x1)",
                                  "BRE",
                                  "-",
                                  (116,250,110)), # Red
                    AlgorithmPlot("BRE (x2)",
                                  "BRE_mult2",
                                  "-",
                                  (188,61,222)), # Green
                    AlgorithmPlot("BRE (x3)",
                                  "BRE_mult3",
                                  "-",
                                  (69,147,250)), # Blue
                    AlgorithmPlot("BRE (x6)",
                                  "BRE_mult6",
                                  "-",
                                  (245,122,80)), # Blue
                    ]

    algorithms += [ AlgorithmPlot("G-BRE (x1)",
                                  "G-BRE_L1_areaMIS_null",
                                  "--",
                                  (116,250,110)), # Orange
                    AlgorithmPlot("G-BRE (x2)",
                                  "G-BRE_L1_areaMIS_null_mult2",
                                  "--",
                                  (188,61,222)), # Yellow
                    AlgorithmPlot("G-BRE (x3)",
                                  "G-BRE_L1_areaMIS_null_mult3",
                                  "--",
                                  (69,147,250)), # Purple
                    AlgorithmPlot("G-BRE (x6)",
                                  "G-BRE_L1_areaMIS_null_mult6",
                                  "--",
                                  (245,122,80)), # Purple
                    ]
